...
const Faq = props =>{
    ...
    return(
        <div className={styles.mainContainer}>
            ...
            {currentUser && auth.currentUser.uid==='K8xuaiYQ0LO6pcALkX5bTdPNCKn1' && <form className={styles.addWordSection}>
            ...
            <section>
                ...
                <li>To add words you need to login via opening the chat in the menu , and to be an admin </li>
